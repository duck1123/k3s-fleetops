  ...
  definitions = {
    ...
    "traefik.io.v1alpha1.IngressRouteSpec" = {
      options = {
        ...
        "parentRefs" = mkOption {
          ...
          type = types.nullOr (coerceAttrsOfSubmodulesToListByKey "traefik.io.v1alpha1.IngressRouteSpecParentRefs" "name" []);
          apply = attrsToList;
        };
        "routes" = mkOption {
    ...
    "traefik.io.v1alpha1.IngressRouteSpecRoutesServices" = {
      options = {
        ...
        "passiveHealthCheck" = mkOption {
          ...
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.IngressRouteSpecRoutesServicesPassiveHealthCheck");
        };
        "port" = mkOption {
    ...
    "traefik.io.v1alpha1.MiddlewareSpecErrorsService" = {
      options = {
        ...
        "passiveHealthCheck" = mkOption {
          description = "PassiveHealthCheck defines passive health checks for ExternalName services.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.MiddlewareSpecErrorsServicePassiveHealthCheck");
        };
        "port" = mkOption {
          description = "Port defines the port of a Kubernetes Service.\nThis can be a reference to a named port.";
          type = types.nullOr (types.either types.int types.str);
    ...
    "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeight" = {
      options = {
        "services" = mkOption {
          ...
          type = types.nullOr (coerceAttrsOfSubmodulesToListByKey "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServices" "name" []);
          apply = attrsToList;
        };
      };
    ...
    "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServices" = {
      options = {
        "healthCheck" = mkOption {
          description = "Healthcheck defines health checks for ExternalName services.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServicesHealthCheck");
        };
        "kind" = mkOption {
          description = "Kind defines the kind of the Service.";
          type = types.nullOr types.str;
        ...
        "passiveHealthCheck" = mkOption {
          description = "PassiveHealthCheck defines passive health checks for ExternalName services.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServicesPassiveHealthCheck");
        };
        "port" = mkOption {
          description = "Port defines the port of a Kubernetes Service.\nThis can be a reference to a named port.";
          type = types.nullOr (types.either types.int types.str);
        ...
        "responseForwarding" = mkOption {
          description = "ResponseForwarding defines how Traefik forwards the response from the upstream Kubernetes Service to the client.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServicesResponseForwarding");
        };
        "scheme" = mkOption {
          description = "Scheme defines the scheme to use for the request to the upstream Kubernetes Service.\nIt defaults to https when Kubernetes Service port is 443, http otherwise.";
          type = types.nullOr types.str;
        ...
        "sticky" = mkOption {
          description = "Sticky defines the sticky sessions configuration.\nMore info: https://doc.traefik.io/traefik/v3.6/reference/routing-configuration/http/load-balancing/service/#sticky-sessions";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServicesSticky");
        };
        "strategy" = mkOption {
          description = "Strategy defines the load balancing strategy between the servers.\nSupported values are: wrr (Weighed round-robin), p2c (Power of two choices), hrw (Highest Random Weight), and leasttime (Least-Time).\nRoundRobin value is deprecated and supported for backward compatibility.";
          type = types.nullOr types.str;
    ...
    "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServicesSticky" = {
      options = {
        "cookie" = mkOption {
          description = "Cookie defines the sticky cookie configuration.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecHighestRandomWeightServicesStickyCookie");
        };
      };
    ...
    "traefik.io.v1alpha1.TraefikServiceSpecMirroring" = {
      options = {
        ...
        "passiveHealthCheck" = mkOption {
          description = "PassiveHealthCheck defines passive health checks for ExternalName services.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecMirroringPassiveHealthCheck");
        };
        "port" = mkOption {
          description = "Port defines the port of a Kubernetes Service.\nThis can be a reference to a named port.";
          type = types.nullOr (types.either types.int types.str);
    ...
    "traefik.io.v1alpha1.TraefikServiceSpecMirroringMirrors" = {
      options = {
        ...
        "passiveHealthCheck" = mkOption {
          description = "PassiveHealthCheck defines passive health checks for ExternalName services.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecMirroringMirrorsPassiveHealthCheck");
        };
        "percent" = mkOption {
    ...
    "traefik.io.v1alpha1.TraefikServiceSpecWeightedServices" = {
      options = {
        ...
        "passiveHealthCheck" = mkOption {
          description = "PassiveHealthCheck defines passive health checks for ExternalName services.";
          type = types.nullOr (submoduleOf "traefik.io.v1alpha1.TraefikServiceSpecWeightedServicesPassiveHealthCheck");
        };
        "port" = mkOption {
          description = "Port defines the port of a Kubernetes Service.\nThis can be a reference to a named port.";
          type = types.nullOr (types.either types.int types.str);
